...
namespace HomeAddvisor.Controllers
{
    public class RegionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Region,Nombre_Region,Numero_Region,Sector")] Region region)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Region,Nombre_Region,Numero_Region,Sector")] Region region)
        {
            if (ModelState.IsValid)
            {
